<h2>Task: clicking checkboxes and radio buttons (captcha for robots)</h2>

<p>Let's continue using the power of robots 🤖 for everyday tasks. In this <a href="https://suninjuly.github.io/math.html" rel="nofollow noopener noreferrer">page</a> we've added a captcha test for robots, i.e., a test that is easy for a computer but complicated for a human.</p>
...
<p>The "text" attribute returns the text located between the opening and closing tags of the element. For example, "text" for the following element <code>&lt;div class="message"&gt;You have a new message.&lt;/div&gt;</code> will return the line: "You have a new message".</p>
