...
<p>При написании следующих тестов, когда нам понадобится перейти к странице логина с главной страницы,
нам не нужно будет копировать этот кусочек кода или писать заново — мы сможем переиспользовать уже написанный метод.</p>

<p> Мы сделали первый шаг в абстракции методов взаимодействия с веб страницей, но это еще не Page Object.</p>
